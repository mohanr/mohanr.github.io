...
I would add this section of code to the list of inefficiences but I am not sure if I am using the correct API.
The following code increments a _bytes_ type by 1. This is only tested lightly but the keys are updated.
{% highlight ocaml %}
