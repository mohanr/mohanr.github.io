          ...
          | Prefix (l, i1, i2) ->
            ...
            let n_48keys = List.mapi (fun i el -> if i = (idx + 1) then
                ...
                if idx <= size && idx <
                    ...
                    Array.set n_48children idx (child);        (*  This child should be a parameter*)
	             (
                 Prefix (l, i1 + 1, i2),
		         node_type,
                 n_48keys,
...
4. When the fresh nodes are created the _Bytes_ list should not contain _\x00_ bytes. This is considered a valid
